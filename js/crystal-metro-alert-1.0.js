...
function metroAlert(data, options)
{
    ...
    var defaults = {
        ...
        onInit : function(){},              // trigger on initialize
        onCloseInit : function(){},         // trigger on close initialize
        onCloseComplete: function(){},      // trigger on close complete
    ...
    if(!setting.updateMetro){
        ...
        if($("#metro_alert_back_layer").length > 0){
            $("#metro_alert_box").removeAttr('class').addClass(setting.boxClass);
            $("#metro_alert_back_layer").removeAttr('class').addClass(setting.layerClass);
            ...
            $(".metro-alert-close-btn").unbind('click').bind("click", function(){
                setting.onClose($(this));
            });            
        }else{            
